...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:9999/shop/home";
    public static String vnp_TmnCode = "0596O91Z";
    public static String vnp_HashSecret = "XGIAVIXQCWPBWZCQKWLYFSGQTHZLOJXO";
